...
(defmacro init-property-address (address id scope &optional (element 0))
  (declare (type c-enum-value id scope))
  `(progn
     (setf (coreaudio::audio-object-property-address-selector ,address) (strint ,id))
     (setf (coreaudio::audio-object-property-address-scope ,address) (strint ,scope))
     (setf (coreaudio::audio-object-property-address-element ,address) ,element)))

(defun get-default-device ()
  (cffi:with-foreign-objects ((address '(:struct coreaudio::audio-object-property-address))
                              (size :uint32)
                              (id :uint32))
    (init-property-address address "dOut" "glob")
...
(defun get-device-sample-rate (&optional (device (get-default-device)))
  (cffi:with-foreign-objects ((address '(:struct coreaudio::audio-object-property-address))
                              (size :uint32)
                              (rate :double))
    (init-property-address address "nsrt" "glob")
      ...
      (unless queue
        (cffi:with-foreign-objects ((queuep :pointer)
          ...
          (cffi:with-foreign-objects ((address '(:struct coreaudio::audio-object-property-address))
                                      (size :uint32)
                                      (id :pointer))
            (init-property-address address "uid " "outp")
